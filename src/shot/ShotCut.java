...
public class ShotCut {
    ...
    public CvScalar extractDomainColor(HistData curHist){
        ...
        //主色结构
        domainMean.val[0] = meanValueH;
        domainMean.val[1] = meanValueS;
        domainMean.val[2] = meanValueV;
        return domainMean;
    }
    ...
    public double calDomainColorRate(BufferedImage img,HistData curHist){
        ...
        dSinHmean = sin( cMeanColor.val[0]*PI/360.0 );
        dCosHmean = cos( cMeanColor.val[0]*PI/360.0 );
    ...
    public double calDomainColorDiff(BufferedImage img1,HistData hist1,BufferedImage img2,HistData hist2){
        ...
        double dSinHmean1 = sin(cMeanColor1.val[0]*PI/360.0);
        double dCosHmean1 = cos(cMeanColor1.val[0]*PI/360.0);
        double dSinHmean2 = sin(cMeanColor2.val[0]*PI/360.0);
        double dCosHmean2 = cos(cMeanColor2.val[0]*PI/360.0);
    ...
    public int shotDetection() throws IOException {
        //h_bins代表h分量
        ...
        //当前帧直方图数据
        HistData curHistData=new HistData();
        //渐变起始帧直方图数据
    ...
    public int setPath(String imgpath,int fCount){
